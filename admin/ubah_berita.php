...
if (isset($_GET['id'])) {
    ...
    $result = mysqli_query($connect, "SELECT * FROM berita WHERE id='$id'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE berita SET judulberita='$judulberita', isiberita='$isiberita', foto='$foto', kategori='$kategori' WHERE id='$id'";
    ...
    <div class="container">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="judulberita" name="judulberita" value="<?php echo htmlspecialchars($data['judulberita']); ?>" required>
            </div>
            <div class="mb-3">
                <label for="isiberita" class="form-label">Isi Berita :</label>
                <textarea class="form-control" id="isiberita" name="isiberita" rows="5" required><?php echo htmlspecialchars($data['isiberita']); ?></textarea>
            </div>
...
<?php include 'footer.php'; ?>
    ...
    <script src="../assets/vendor/php-isiberita-form/validate.js"></script>
